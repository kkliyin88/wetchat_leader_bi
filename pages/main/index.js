...
Page({
  ...
  data: {
   ...
   listData:[
     {"code":"01","text":"text1","type":"type1",name:'DW'},
     {"code":"02","text":"text2","type":"type2",name:'DW'},
     {"code":"03","text":"text3","type":"type3",name:'DW'},
     {"code":"04","text":"text4","type":"type4",name:'DW'},
     {"code":"05","text":"text5","type":"type5",name:'DW'},
     {"code":"06","text":"text6","type":"type6",name:'DW'},
     {"code":"07","text":"text7","type":"type7",name:'DW'}
   ],
   columns:[
	   {},
